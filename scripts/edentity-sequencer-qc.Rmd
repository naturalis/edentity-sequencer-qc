...
This section looks at the total number of reads per marker
...
Then we look at the average number of reads per  marker
...
ggplot(merged_df, aes(x = sequencer, y = num_seqs, color = marker)) +
  ...
  scale_y_continuous(labels = comma)+
  labs(y = "Average Number of Reads per file", x = "Sequencer", 
       title = "Average Number of reads by Sequencer per Marker") +
  theme_minimal() +
